...
public class RocksDBSessionsTest extends BaseRocksDBUnitTest {
    ...
    @Test
    public void testSnapshot() throws RocksDBException {
        this.rocks.session().put(TABLE, b("person:1gname"), b("James"));
        this.rocks.session().commit();

        String snapshotFile = this.rocks.createSnapshot(SNAPSHOT_PATH);
        ...
        this.rocks.resumeSnapshot(Paths.get(SNAPSHOT_PATH, snapshotFile)
                                       .toString());
